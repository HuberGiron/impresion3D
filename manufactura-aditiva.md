...
**4. Laminado:** El software laminador, también llamado slicer, divide el modelo en capas y genera las trayectorias que la impresora debe seguir. En este paso se definen parámetros como altura de capa, porcentaje de relleno, temperatura, soportes, velocidad y orientación.

**5. Impresión:** La máquina ejecuta las instrucciones. En FDM, deposita filamento fundido. En resina, solidifica un fotopolímero. En SLS, fusiona polvo. Aunque la lógica de control varía, todas las tecnologías comparten la idea de construir la pieza a partir de información digital.
